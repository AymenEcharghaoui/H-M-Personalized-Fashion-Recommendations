...
transactions_dir = '/home/echarghaoui/github_Aymen/H-M-Personalized-Fashion-Recommendations/data/transactions_train_10.csv'
...
items = transactions_train.groupby('customer_id')['article_id'].apply(list)
